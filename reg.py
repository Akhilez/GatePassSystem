...
try:
    ...
    #cur.execute("create table staff(name varchar,mob int unique,email varchar primary key,gender varchar,dob date,password varchar,role varchar)");
    def insert():
 ...
 <div id="header">
    ...
    <form>
    <div id="heading"><h3 align="center" >Receptionist Registration<h2></div><br>
    <table><tr><td>
