...
try:
	...
	<div id="container">
		...
		<li>This Web Application facilitates the College Management to Issue and Monitor the Students who are requesting for Gatepass.</li>
			...
			<div id="main2">
				<h2>GATE PASS</h2><br/><hr/></br><br><br>
			<ul type="disc"><table align="center"><tr><td><li><a href="dreg.py">Director Sign up</a></li><br></tr></td>
					<tr><td><li><a href="reg.py" >Receptionist Sign up</a></li><br></tr></td>
					<tr><td><li><a href="greg.py">Guard Sign up</a></li><br></tr></td>
					<tr><td><li><a href="areg.py">Administrator Signup</a></li></tr></td></table>
				</ul>
			</div>
			</div>
		</div>
